...
public class AStarExp_993083613_999550263 implements AIModule{
    
    // To enable a efficient behavior for the PriorityQueue
    public class NodeComparator implements Comparator<AStarExp_993083613_999550263.Node>, Serializable{
    	public int compare(AStarExp_993083613_999550263.Node n1, AStarExp_993083613_999550263.Node n2){
	...
	public AStarExp_993083613_999550263.Node parent; // from where it came from
	public double g;
	public double f;
	...
	public boolean equals(Object obj){
	    ...
	    final AStarExp_993083613_999550263.Node other = (AStarExp_993083613_999550263.Node) obj;
	...
	PriorityQueue<AStarExp_993083613_999550263.Node> pQueue = new PriorityQueue<AStarExp_993083613_999550263.Node>(10,new NodeComparator()); 
	Map<String, AStarExp_993083613_999550263.Node> openSet = new HashMap<String, AStarExp_993083613_999550263.Node>();
	Map<String, AStarExp_993083613_999550263.Node> closedSet = new HashMap<String, AStarExp_993083613_999550263.Node>();
	AStarExp_993083613_999550263.Node start = new AStarExp_993083613_999550263.Node(map, map.getStartPoint(), 0.0);
	AStarExp_993083613_999550263.Node end = new AStarExp_993083613_999550263.Node(map, map.getEndPoint(),0.0);
	...
	while(openSet.size()>0){
	    ...
	    AStarExp_993083613_999550263.Node x = pQueue.poll();
	    openSet.remove(x.id);
		...
		for (int i=0; i < neighbors.length; i++){
		    ...
		    AStarExp_993083613_999550263.Node visited = closedSet.get(neighbors[i].x+","+neighbors[i].y); 
		    if (visited == null){
			double g = x.g + map.getCost(x.point, neighbors[i]);
			AStarExp_993083613_999550263.Node n = openSet.get(neighbors[i].x+","+neighbors[i].y);
			
			// if the neighbor is not in the openSet, initialize a new one adding it to the sets
			if (n == null){ 
			    n = new AStarExp_993083613_999550263.Node(map, neighbors[i], g);
			    n.parent = x;
			    openSet.put(n.id, n);
			    pQueue.add(n);
			}
     ...
     */
    public List<Point> reconstructPath(AStarExp_993083613_999550263.Node node){
